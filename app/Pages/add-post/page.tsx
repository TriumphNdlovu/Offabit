...
<form className = "flex px-5 boarder boarder-2 flex-col"> 
    <div className="grid gap-6 mb-6 md:grid-cols-2 text-white" >
        ...
        <div>
            <label  className="block mb-2 text-sm font-medium  dark:text-white">Website URL</label>
        ...
        <div>
            <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unique visitors (per month)</label>
